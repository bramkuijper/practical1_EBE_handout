...
Let us look again at the Prisoner's dilemma: altruists ($A$) do better than nonaltruists $NA$ (originally called 'Defect' in the lecture slides but I change notation to avoid confusion with Dove) when $W_{A} > $W_{NS}$, which eventually results in (see lecture slides):
\begin{align}
